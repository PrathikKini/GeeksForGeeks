<h2><a href="https://practice.geeksforgeeks.org/problems/upper-case-conversion5419/1?page=1&difficulty[]=-2&status[]=unsolved&sortBy=submissions">Upper case conversion</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string str, convert the first letter of each word in the string to uppercase.&nbsp;</span></p>
