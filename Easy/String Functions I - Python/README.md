<h2><a href="https://www.geeksforgeeks.org/problems/string-functions-i/1?page=3&difficulty=School,Basic,Easy&status=unsolved&sortBy=accuracy">String Functions I - Python</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Python has a lot of string methods that can be used to manipulate the strings like converting to lowercase, capitalizing, trimming the spaces and so on.</span></p>
